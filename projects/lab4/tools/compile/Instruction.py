...
#   inst                type        opcode      funct3  funct6
    ...
    'vsub.vv'   :   [   'OPIVV',    '1010111',  '000',  '000010'    ], #new task 2
    'vsub.vx'   :   [   'OPIVX',    '1010111',  '100',  '000010'    ], #new task 2

    'vmul.vv'   :   [   'OPMVV',    '1010111',  '010',  '100101'    ],
    'vmul.vx'   :   [   'OPMVX',    '1010111',  '110',  '100101'    ],

    'vdiv.vv'   :   [   'OPMVV',    '1010111',  '010',  '100001'    ], #new task 2
    'vdiv.vx'   :   [   'OPMVX',    '1010111',  '110',  '100001'    ], #new task 2

    'vmin.vv'   :   [   'OPIVV',    '1010111',  '000',  '000101'    ], #new task 3
    'vmin.vx'   :   [   'OPIVX',    '1010111',  '100',  '000101'    ], #new task 3

    'vmax.vv'   :   [   'OPIVV',    '1010111',  '000',  '000111'    ], #new task 3
    'vmax.vx'   :   [   'OPIVX',    '1010111',  '100',  '000111'    ], #new task 3

    'vsra.vv'   :   [   'OPIVV',    '1010111',  '000',  '101001'    ], #new task 3
    'vsra.vx'   :   [   'OPIVX',    '1010111',  '100',  '101001'    ], #new task 3
    'vsra.vi'   :   [   'OPIVI',    '1010111',  '011',  '101001'    ], #new task 3

    'vredsum.vs':   [   'OPMVV',    '1010111',  '010',  '000000'    ], #new task 3
    'vredmax.vs':   [   'OPMVV',    '1010111',  '010',  '000111'    ], #new task 3

    'vmv.x.s':      [   'OPMVV',    '1010111',  '010',  '010000'    ], #new task 2
    'vmv.v.x':      [   'OPIVX',    '1010111',  '100',  '010111'    ], #new task 2
...
def InstGen(list_inst, label_dict, current_index, issue_num=1):
    ...
    if  (the_type == 'NOP'):
    ...
    elif(the_type == 'OPIVV' or the_type == 'OPMVV'):
        opcode = inst_info[1]
        funct3 = inst_info[2]
        funct6 = inst_info[3]
        ...
        if(code == 'vmv.x.s'):
            ...
            the_inst = InstructionGen_OPIVV( opcode, funct3, funct6, rd, vs1, vs2, vm )
    ...
    elif(the_type == 'OPIVX' or the_type == 'OPMVX'):
        opcode = inst_info[1]
        funct3 = inst_info[2]
        funct6 = inst_info[3]
